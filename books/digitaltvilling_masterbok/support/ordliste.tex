...
Forprosjektcanvas & Project initiation canvas & Visuelt rammeverk som strukturerer problemforståelse, interessenter, gevinsthypoteser og ressursbehov før et digitalt tvilling-prosjekt formaliseres. \\
Datastrømskartlegging & Data flow mapping & Systematisk kartlegging av hvordan data beveger seg mellom kilder, plattformer og tvillingkomponenter, inkludert lisens- og etterlevelseskrav. \\
Gevinsthypotese & Benefit hypothesis & Begrunnet antakelse om hvilken verdi et tiltak skal generere, brukt til å prioritere og evaluere tvillinginitiativer. \\
Modell- og simuleringsplan & Model and simulation plan & Dokument som beskriver mål, metodikk, scenarier og sjekkpunkter for modell- og simuleringsarbeid i tvillingprosjekter. \\
Risiko- og gevinstjournal & Risk and benefit log & Felles register som sporer risikofaktorer, tiltak, forventede gevinster og status for oppfølging i digitale tvilling-prosjekter. \\
Etterprøvbarhetslogg & Traceability log & Oversikt over beslutninger, versjoner og dokumentasjon som gjør det mulig å etterprøve hvordan data, modeller og leveranser henger sammen. \\
Fagfelleklareringssjekkliste & Peer review clearance checklist & Kontrolliste som bekrefter at dokumentasjon, arbeidsark og kvalitetskrav er oppfylt før leveransen sendes til fagfellevurdering. \\
\bottomrule
\end{longtable}
