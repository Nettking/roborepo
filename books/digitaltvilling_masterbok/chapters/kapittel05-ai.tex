...
\begin{table}[htbp]
    ...
    \begin{tabular}{p{3.2cm}p{3.2cm}p{3.2cm}p{3.2cm}p{3.2cm}}
        ...
        \addlinespace
        Etterlevelse og refleksjon & Ingen vurdering av sikkerhet, etikk eller lovverk. & Noterer enkelte krav uten tiltak. & Tiltak knyttes til relevante standarder og roller. & Integrerer krav fra Kapittel~6 og beskriver hvordan tiltak revideres over tid. \\
        \bottomrule
    \end{tabular}
\end{table}
