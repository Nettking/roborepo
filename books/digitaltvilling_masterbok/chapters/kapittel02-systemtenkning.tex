...
\begin{figure}[ht]
    \centering
    \resizebox{\textwidth}{!}{\input{support/figurer/kilder/kap02-systemkart-v2.tikz}}
...
\begin{figure}[ht]
    \centering
    \resizebox{0.9\textwidth}{!}{\input{support/figurer/kilder/kap02-politikk-ramme-v1.tikz}}
